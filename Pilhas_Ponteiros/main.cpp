/*
pilhas são listas lineares em que todas as operações de inserção e de remoção são feitas por um único extremo denominado topo,ou seja, as pilhas são estruturas baseadas no princípio de last in first out, o último a entrar é o primeiro a sair
*/
    ...
    cout << "5 - Mostrar a pilha: \n";
		...
		switch( op ){
			...
			case 1: // inserir elemento no inicio
				cout << "Qual o valor para ser inserido no inicio da pilha? ";
				cin >> valor;
        x.valor=valor;
        Empilha(x, pilha);
        cout << "valor inserido com sucesso no inicio da pilha" << endl << endl;
				break;
        ...
        cout << "valor " << x.valor << " removido da pilha" << endl << endl;
				break;
      

      case 3: //  tamanho da lista
        cout << "Pilha vazia?: " <<  VerificaVazia(pilha) << endl;
        cout << "Tamanho da pilha: " << Tamanho_pilha(pilha)  << endl << endl;
        break;
      
      case 4: //  fazer lista vazia
        Esvazia(pilha);
        cout << "Pilha ficou vazia" << endl << endl;
        break;
